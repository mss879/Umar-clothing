...
export function DataTable<T>({ data, columns, keyExtractor, emptyState = "No data found.", onRowClick }: DataTableProps<T>) {
  if (data.length === 0) {
    return (
        ...
        <tbody className="divide-y divide-gray-200">
          {data.map((row) => (
            <tr 
              ...
              className={cn("hover:bg-gray-50 transition-colors group", onRowClick && "cursor-pointer")}
